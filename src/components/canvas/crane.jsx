...
const Crane = ({ isMobile }) => {
  const model = useGLTF("./crane/scene.gltf");
  ...
  return (
    <group>
      ...
      <primitive
        ...
        position={isMobile ? [0, -0.2, 0] : [0, -0.3, 0] } // Adjust this position to move the rotation center
